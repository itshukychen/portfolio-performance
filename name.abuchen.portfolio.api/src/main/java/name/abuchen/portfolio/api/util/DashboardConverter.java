package name.abuchen.portfolio.api.util;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import name.abuchen.portfolio.api.dto.ColumnDto;
import name.abuchen.portfolio.api.dto.DashboardDto;
import name.abuchen.portfolio.api.dto.WidgetDto;
...
public class DashboardConverter {
    ...
    public static List<DashboardDto> toDtoList(List<Dashboard> dashboards) {
        ...
        System.out.println("DashboardConverter: Converting " + dashboards.size() + " dashboards to " + dtos.size() + " DTOs");
        return dtos;
    }
}
