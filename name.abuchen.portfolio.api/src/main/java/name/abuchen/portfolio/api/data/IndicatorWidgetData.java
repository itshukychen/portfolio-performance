...
public class IndicatorWidgetData<N> {
    ...
    public Map<String, Object> generateData() {
        try {
            ...
            if (reportingPeriod == null) {
                logger.warn("No reporting period found for widget: {}", widgetId);
                return createErrorResponse("No reporting period configured");
            }
    ...
    private DataSeries getDataSeriesFromConfig() {
        ...
        String uuid = config.get("DATA_SERIES");
    ...
    private Interval getReportingPeriodFromConfig() {
        // TODO: Implement reporting period extraction from config
